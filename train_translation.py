...
用法:
  python train_translation.py --epochs 30 --batch_size 32
  python train_translation.py --help
...
def main():
    ...
    trainer.save_model("checkpoint_translation.pth")
    trainer.export_history("history_translation.json")
    trainer.plot_curves("curves_translation.png")
